  ...
  return (
    <div className="contacts-container">
      <div className="contacts-contacts">
        ...
        <br />
        <a className="contacts-contacts-links" href="mailto:building@gmail.com">
          <span>
            <Icon
              id="mail"
              width={24}
        ...
        <br />
        <a className="contacts-contacts-links" href="https://shorturl.at/C1JJj">
          <Icon
            id="location"
            width={24}
            height={24}
          ...
          />
          <br />
          <span className="contacts-contacts-text">Senovážné nám. 987/15</span>
        </a>
      </div>
